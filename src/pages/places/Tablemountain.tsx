  ...
  const highlights = [
    {
      ...
      description:
        "Reach the summit effortlessly while enjoying sweeping views of Cape Town",
    },
    {
      icon: <Camera className="w-6 h-6" />,
      title: "Panoramic Views",
      description:
        "Capture breathtaking city, coastline, and ocean vistas from the top",
    },
    {
      icon: <Compass className="w-6 h-6" />,
      title: "Hiking Trails",
      description:
        "Explore trails ranging from easy strolls to challenging climbs",
    },
    {
      icon: <MapPin className="w-6 h-6" />,
      title: "Unique Flora & Fauna",
      description:
        "Discover the mountain's rich biodiversity, including endemic fynbos",
    },
  ];
        ...
        <div className="absolute inset-0 flex items-center justify-center text-primary-foreground text-center px-4">
          <div className="max-w-3xl animate-fade-up">
            ...
            <p className="text-xl md:text-2xl opacity-90">
              Cape Town's Most Glamorous Mountain
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Table Mountain is one of Cape Town's most iconic landmarks,
                  towering above the city with its flat-topped summit and
                  dramatic cliffs. This natural wonder offers breathtaking
                  panoramic views of the city, coastline, and surrounding
                  mountains, making it a must-visit destination for both locals
                  and tourists.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Visitors can explore a variety of hiking trails ranging from
                  easy walks to challenging climbs, or take the cable car to the
                  summit for an effortless journey. The mountain is home to
                  unique flora and fauna, including endemic fynbos and diverse
                  birdlife, making it a paradise for nature enthusiasts and
                  photographers alike.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Table Mountain attracts adventurers, hikers, and sightseers
                  year-round. Whether you're capturing sunrise and sunset views,
                  spotting wildlife, or simply enjoying the fresh mountain air,
                  it offers an unforgettable experience overlooking Cape Town.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-gradient-ocean text-primary-foreground">
                ...
                <p className="mb-6 text-sm opacity-90">
                  Include Table Mountain in your Cape Town tour and experience
                  ...
                  onClick={() =>
                    window.open(
                      "https://wa.me/27781275522?text=" +
                        encodeURIComponent("I'd like to visit Table Mountain"),
                      "_blank"
                    )
                  }
                >
          ...
          <Card className="p-8 bg-gradient-sunset text-primary-foreground text-center">
            <h3 className="text-2xl font-bold mb-4">
              Explore Things to Do at Table Mountain
            </h3>
            <p className="mb-6 opacity-90">
              Hiking, cable car rides, wildlife spotting, and panoramic city
              views
            </p>
