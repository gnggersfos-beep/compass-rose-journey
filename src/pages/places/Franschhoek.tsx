...
const CampsBay = () => {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description:
        "Discover historic sites celebrating Franschhoek’s French settlers",
    },
  ];
        ...
        <div className="absolute inset-0 flex items-center justify-center text-primary-foreground text-center px-4">
          <div className="max-w-3xl animate-fade-up">
            ...
            <p className="text-xl md:text-2xl opacity-90">
              The Heart of South Africa’s Wine Country
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Franschhoek is a picturesque town in South Africa's Cape
                  Winelands, renowned for its world-class vineyards, charming
                  streets, and French Huguenot heritage. Nestled in a valley
                  surrounded by dramatic mountains, Franschhoek offers a serene
                  escape with rolling vineyards, boutique galleries, and gourmet
                  restaurants.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Known as the “food and wine capital” of South Africa, the town
                  combines culinary excellence with breathtaking scenery.
                  Visitors can explore historic wine estates, enjoy tasting
                  experiences, and stroll through art-filled streets that
                  celebrate the town’s rich cultural heritage.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Franschhoek attracts both locals and international travelers
                  seeking sophistication, relaxation, and authentic experiences.
                  From vineyard tours and fine dining to cultural sites and
                  scenic walks, the town offers an unforgettable blend of
                  history, flavor, and natural beauty.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-gradient-ocean text-primary-foreground">
                ...
                <p className="mb-6 text-sm opacity-90">
                  Include Franschhoek in your Cape Town tour and experience one
                  ...
                  onClick={() =>
                    window.open(
                      "https://wa.me/27781275522?text=" +
                        encodeURIComponent("I'd like to visit Franschhoek"),
                      "_blank"
                    )
                  }
                >
          ...
          <Card className="p-8 bg-gradient-sunset text-primary-foreground text-center">
            <h3 className="text-2xl font-bold mb-4">
              Explore Things to Do in Franschhoek
            </h3>
            <p className="mb-6 opacity-90">
              Wine tastings, gourmet dining, vineyard walks, and art gallery
              visits
            </p>
