        ...
        <div className="absolute inset-0 flex items-center justify-center text-primary-foreground text-center px-4">
          <div className="max-w-3xl animate-fade-up">
            ...
            <p className="text-xl md:text-2xl opacity-90">
              Cape Town's Most Colorful Neighbourhood
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Bo-Kaap is one of Cape Town’s most vibrant and historic
                  neighborhoods, known for its brightly painted houses,
                  cobblestone streets, and rich cultural heritage. Nestled
                  against the slopes of Signal Hill, this area is a living
                  testament to resilience, community, and tradition.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Originally established in the 1760s, Bo-Kaap was home to freed
                  slaves, artisans, and immigrants brought to the Cape from
                  Malaysia, Indonesia, and other parts of Africa and Asia. Over
                  the centuries, these communities blended their traditions,
                  giving rise to a unique Cape Malay culture that continues to
                  shape the area today.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  The neighborhood is famous for its colorful houses, each one
                  painted in bold hues that represent freedom, individuality,
                  and joy. Walking through Bo-Kaap, you’ll encounter the sounds
                  of the athaan (call to prayer) from centuries-old mosques, the
                  aroma of spices drifting from family kitchens, and the warmth
                  of a community that has preserved its identity through
                  generations. Bo-Kaap is more than a tourist destination—it is
                  a living, breathing heritage site. It embodies history, faith,
                  and culture, while also representing the ongoing fight to
                  preserve traditions in the face of modern challenges. From its
                  delicious Cape Malay cuisine to its festivals, music, and
                  stories, Bo-Kaap stands as a symbol of Cape Town’s
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-gradient-ocean text-primary-foreground">
                ...
                <p className="mb-6 text-sm opacity-90">
                  Include Bo-Kaap in your Cape Town tour and experience one of
                  the world's most beautiful neighborhoods.
                </p>
                <Button
          ...
          <Card className="p-8 bg-gradient-sunset text-primary-foreground text-center">
            <h3 className="text-2xl font-bold mb-4">
              Explore Things to Do in Bo Kaap
            </h3>
