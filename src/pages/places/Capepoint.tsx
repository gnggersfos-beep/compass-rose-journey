  ...
  const highlights = [
    {
      ...
      description:
        "Visit the iconic lighthouse perched on the cliffs with panoramic views",
    },
    {
      icon: <Camera className="w-6 h-6" />,
      title: "Scenic Views",
      description:
        "Capture breathtaking ocean vistas, cliffs, and dramatic landscapes",
    },
    {
      icon: <Compass className="w-6 h-6" />,
      title: "Nature Trails",
      description:
        "Explore hiking paths through fynbos, coastal cliffs, and wildlife areas",
    },
    {
      icon: <MapPin className="w-6 h-6" />,
      title: "Cape of Good Hope",
      description:
        "Stand at the famous landmark where the Atlantic and Indian Oceans meet",
    },
  ];
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Cape Point is a dramatic promontory at the southeastern tip of
                  the Cape Peninsula, where the Atlantic and Indian Oceans
                  converge. Famous for its rugged cliffs, sweeping ocean views,
                  and rich biodiversity, Cape Point is part of the Table
                  Mountain National Park and offers a truly spectacular natural
                  setting.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  The area features scenic hiking trails, iconic lighthouses,
                  and lookout points that provide breathtaking panoramas of the
                  coastline. Visitors can spot wildlife, explore the fynbos
                  vegetation, and experience one of South Africa’s most
                  photographed natural landmarks.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Cape Point attracts both nature enthusiasts and adventure
                  seekers from around the world. With dramatic cliffs, powerful
                  ocean waves, and rich flora and fauna, it offers an
                  unforgettable experience for all who visit this iconic
                  destination.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-gradient-ocean text-primary-foreground">
                ...
                <p className="mb-6 text-sm opacity-90">
                  Include Cape Point in your Cape Town tour and experience one
                  ...
                  onClick={() =>
                    window.open(
                      "https://wa.me/27781275522?text=" +
                        encodeURIComponent("I'd like to visit Cape Point"),
                      "_blank"
                    )
                  }
                >
          ...
          <Card className="p-8 bg-gradient-sunset text-primary-foreground text-center">
            <h3 className="text-2xl font-bold mb-4">
              Explore Things to Do in Cape Point
            </h3>
            <p className="mb-6 opacity-90">
              Hiking, wildlife spotting, lighthouse visits, and scenic ocean
              views
            </p>
